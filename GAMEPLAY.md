...
| 8 | **Sandstorm Vaults** | Wide desert U | 340 | 18 | Bard | Mummy |
| 9 | **War Camp** | Staggered siege descent | 360 | 17 | — | Orc |
| 10 | **Witchwood** | Winding forest path | 380 | 16 | Prince | Witch |
| 11 | **Stone Keep** | Keep circuit loop | 400 | 16 | — | Gargoyle |
...
> **Royal units (Prince, Princess):** limited to **3 of each** on the map at
> once. Invalid spots show a red tile, same as an unbuildable tile. The Princess's
> aura **does not stack**: a tower under two princess auras keeps only the
> strongest buff.
...
| Princess ✨     | Royal aura + bolts| Long range bolts (slow) AND buffs nearby towers | Max 3 |
...
| Princess    | 150  | 16     | 150   | 1.1/s     | Slows (0.55×/1.0s), hits air; aura +15% dmg/rate within 130px; max 3 |
